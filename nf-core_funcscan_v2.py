    ...
    for i in id:
        if i != '':
            try :
                ...
                out = output+"/"+i
                os.system("python SPAdes-3.15.5-Linux/bin/spades.py -1 "+R1+" -2 "+R2+" -o "+out)
                end = datetime.now()
    ...
    for i in id :
        if i != '':
            try:
                ...
                os.system("python SPAdes-3.15.5-Linux/bin/spades.py -s "+R+" -o "+out)
                end = datetime.now()
                time.write(str(start)+'\t'+str(end)+'\n')
            except:
                print ("Error "+i)
